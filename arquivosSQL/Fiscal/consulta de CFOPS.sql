 ...
 --   decode(xPCNFENT.VLTOTAL, 0, PCESTCOM.VLDEVOLUCAO, PCNFENT.VLTOTAL) as VLTOTAL,
 --   case 
...
join VW_DEVOL_AVUL D on M.NUMNOTA = D.NOTA_ENT and M.CODFILIAL = D.FILIAL
join PCNFENT  H on M.NUMNOTA = H.NUMNOTA and H.CODFILIAL = M.CODFILIAL
where 0=0
and D.DTENT between (:DATINI) and (:DATFIM)
